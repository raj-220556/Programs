...
int main()
{
	// //1....lowercase to uppercase and uppercase to lowercase
	// char name[100];
	// char str[100];
	...
	// //2....print no.of vowels,consonants and numbers
	// char word[100];
	// printf("Enter the string : ");
	// gets(word);
	// printf("The entered string is %s\n",word);
...
// 	//4....sort the characters of a string
// 	char string[100];
// 	char string1[100];
// 	printf("Enter the string :");
// 	gets(string);
...
// 		i++;
// 	}
// 	printf("\nThe desending order sorted string is << %s >>\n",string);
// 	printf("\nThe assending order sorted string is << %s >>\n",string1);
